                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($cartItems as $cartItem)
                            ...
                            @endphp
                            @if($cartItem->generated_by !== 'admin') {{-- Check if the product is not generated by admin --}}
                                <tr>
                                    <td>
                                        {{ $cartItem->name }}<br>
        ...
        <div class="col-md-9">
            <div class="card cart-summery">
                ...
                <div class="card-body">
                    ...
                    @foreach($cartItems as $cartItem)
                        @if($cartItem->generated_by !== 'admin') {{-- Exclude admin-generated products --}}
                            @php
                    ...
                    <div class="d-flex justify-content-between summery-end">
                        <div>Total</div>
                        <div id="total">${{ number_format($subtotal + (isset($giftCard) ? $giftCard->amount : 0), 2) }}</div>
                    </div>
                    <div class="pt-5">
