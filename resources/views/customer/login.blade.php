...
<body>
    ...
    @if(Session::has('success'))
        ...
        <div class="login-container">
            <h2>ONLYAPPROVED</h2>
            <form action="{{route('customer.authenticate')}}" method="POST" id="registerForm">
                @csrf
                ...
                <button type="submit" class="g-recaptcha btn btn-login"
                        data-sitekey="{{ config('services.recaptcha.v3.site_key') }}"
                        data-callback="onSubmit"
                        data-action="submit">Login</button><br><br>
